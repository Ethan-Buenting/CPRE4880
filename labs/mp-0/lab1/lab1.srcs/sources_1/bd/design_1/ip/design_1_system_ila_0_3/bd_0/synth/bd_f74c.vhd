...
architecture STRUCTURE of bd_f74c is
  ...
  signal probe6_1 : STD_LOGIC_VECTOR ( 23 downto 0 );
...
begin
  ...
  probe4_1(0) <= probe4(0);
  probe5_1(0) <= probe5(0);
  probe6_1(23 downto 0) <= probe6(23 downto 0);
  probe7_1(0) <= probe7(0);
ila_lib: component bd_f74c_ila_lib_0
     port map (
      ...
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      probe10(0) => SLOT_0_VIDEO_TIMING_hsync_1,
      probe11(0) => SLOT_0_VIDEO_TIMING_vblank_1,
      probe12(0) => SLOT_0_VIDEO_TIMING_vsync_1,
      probe2(0) => probe2_1(0),
      probe3(23 downto 0) => probe3_1(23 downto 0),
      probe4(0) => probe4_1(0),
      probe5(0) => probe5_1(0),
      probe6(23 downto 0) => probe6_1(23 downto 0),
      probe7(0) => probe7_1(0),
      probe8(0) => SLOT_0_VIDEO_TIMING_active_video_1,
      probe9(0) => SLOT_0_VIDEO_TIMING_hblank_1
    );
end STRUCTURE;
