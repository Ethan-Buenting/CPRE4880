...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net SLOT_1_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_1_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_1_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_1_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_1_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_1_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe27]
