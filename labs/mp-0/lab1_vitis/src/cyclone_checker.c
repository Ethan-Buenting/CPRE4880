...
//    			for (k = 0; k < 159; k++) {
//					if (k < 80) {
//					  cyclone_checker[i * 60 + a][j * 159 + k] = color1;
//					}
//					else {
//					  cyclone_checker[i * 60 + a][j * 159 + k] = color2;
//					}
//    			}
//
//    		}
