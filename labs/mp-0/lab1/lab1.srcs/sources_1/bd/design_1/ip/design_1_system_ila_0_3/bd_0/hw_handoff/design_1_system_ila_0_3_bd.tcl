...
proc create_root_design { parentCell } {
  ...
  set probe6 [ create_bd_port -dir I -from 23 -to 0 probe6 ]
  ...
  connect_bd_net -net SLOT_0_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_0_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_0_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_0_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe10]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_0_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_0_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe12]
